...
INCLUDES :=  -I$(PYTHON_INCLUDE_PATH) -I$(CBLAS_INCLUDE_PATH) -I$(NUMPY_INCLUDE_PATH) -I./include -I./include/common -I./include/cudaconv2 -I./include/nvmatrix -I$(CUDA_SDK_PATH) -I./include/dummyinclude
